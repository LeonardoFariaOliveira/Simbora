...
export default function HasUserBeenFoundModal({latitude, longitude, setHasUserBeenFound}:HasUserBeenFoundModalProps){
    ...
    return(
        <>
            <div className="bg-light-green slide-on-modal absolute z-10 md:top-[9rem] top-[20rem] right-1 md:right-3 rounded-[4px] py-5 pl-2 md:pl-6 pr-0 mb-4 max-w-[17rem] md:max-w-[24rem]  w-full text-base border-green border text-black" role="alert">
